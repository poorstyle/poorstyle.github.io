...
(function (window, document, $, undefined) {
	...
	F.helpers.overlay = {
		...
		// 				console.log('success!');
			...
			console.log(_rotate)
			if(_rotate){
				$('<div class="rotate-bar"><span class="rotate01"></span><span class="rotate02"></span><span class="rotate03"></span></div>').appendTo( '.fancybox-overlay' )
				
				$('.rotate01').on('click',function(e){
					var _rotate=$('.fancybox-wrap').css('transform');
					_deg-=90;
					console.log(_deg)
					$('.fancybox-wrap').css('transform','rotate('+_deg+'deg)');
					e.preventDefault();
				})

				$('.rotate02').on('click',function(e){
					var _rotate=$('.fancybox-wrap').css('transform');
					_deg+=90;
					console.log(_deg)
					$('.fancybox-wrap').css('transform','rotate('+_deg+'deg)');
		...
		// 		// body...
		// 			$('<div class="rotate-bar"><span class="rotate01"></span><span class="rotate02"></span></div>').appendTo( '.fancybox-overlay' )		
		// 				console.log('success!');
		// 	}, 1500);
